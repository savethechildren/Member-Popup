...
let prefix = function(country) {
    var lng = stc.i18n[stc.geo.userLanguage.substr(0, 2)] ? stc.i18n[stc.geo.userLanguage.substr(0, 2)] : stc.i18n.default;
    var prefix = '';
